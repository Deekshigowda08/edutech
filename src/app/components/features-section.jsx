    ...
    <section id={id} className="features-section">
      <div className="flex flex-col md:flex-row items-center bg-white py-12 px-6 md:px-12">
        <div className="md:w-1/3 mb-6 md:mb-0">
          <Image
            src="/images/colabration.png?height=250&width=250"
        ...
        <div className="md:w-2/3 md:pl-8">
          ...
          Collaboration is at the core of our success, and we are proud to partner with the <strong>National Skill Development Corporation (NSDC)</strong> to design impactful courses. Through this partnership, we ensure our content remains relevant and insightful, blending industry expertise with innovation to empower learners. Together with NSDC, we help individuals achieve their goals, make meaningful progress in their careers, and contribute to a skilled workforce. Additionally, we provide internship opportunities that offer hands-on experience, bridging the gap between theory and practice to prepare learners for real-world challenges.
          </p>
